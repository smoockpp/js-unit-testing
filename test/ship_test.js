...
describe('fireShot', function() {
  ...
  it('should NOT record damage if no ship at given coordinate', function() {
...
// Method to call to fire opponent
// Use checkForShip to confirm players guess
// SHould use damageShip to register damage on their opponent
// equal , not.equal , deep, include
